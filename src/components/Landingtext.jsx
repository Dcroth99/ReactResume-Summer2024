...
export default function Landingtext() {
  return (
    <div className={styles.aboutLanding}>
      ...
      <p>
        I am a <span className={styles.highlight}>Web Developer</span> with experience across multiple programming languages and technologies. I am passionate about creating user-friendly applications that solve real-world problems.
      </p>
